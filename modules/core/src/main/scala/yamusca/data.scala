...
object data {
  ...
  object Element {
    implicit def elementShow(implicit s1: Show[Literal], s2: Show[Variable], s3: Show[Section], s4: Show[Comment]): Show[Element] =
      Show {
  ...
  object Section {
    implicit def sectionShow(implicit s1: Show[Literal], s2: Show[Variable], s3: Show[Comment]): Show[Section] = {
